        ...
        <td>
          <div class="acciones-tabla">
            ...
            ${modulo === "REVENDEDOR" ? `
              <button
                type="button"
                class="boton-accion tienda-toggle ${String(registro.tiendaActiva || "SI").toUpperCase() === "NO" ? "apagada" : "activa"}"
                data-accion="tienda"
                data-id="${escaparHtml(registro.id)}"
                title="${String(registro.tiendaActiva || "SI").toUpperCase() === "NO" ? "Activar tienda" : "Apagar tienda"}"
                aria-label="${String(registro.tiendaActiva || "SI").toUpperCase() === "NO" ? "Activar tienda" : "Apagar tienda"}"
              >
